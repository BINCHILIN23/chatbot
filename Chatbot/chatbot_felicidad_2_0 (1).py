...
loaded_chatbot_nb = joblib.load('chatbot_nb_model.pkl')

import os
import shutil

# Define the source and destination paths
source_path = 'chatbot_nb_model.pkl'
destination_dir = '/content/drive/MyDrive/Chatbot/' # Replace 'Chatbot/' with your desired folder name in Google Drive
...
print(f"Model '{source_path}' copied to '{destination_dir}'")